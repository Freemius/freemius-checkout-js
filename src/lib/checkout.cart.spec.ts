...
describe('Checkout with Cart', () => {
    test("should open automatically if the cart is present in the URL and cart's plugin ID matches", () => {
        ...
        expect(search.get('__fs_authorization')).toMatchInlineSnapshot(`"FSE 9885:Fq28cI8tXbGkuMc7Up-A632PqvplKYYTbz9JEjdgXR3Rlc2PrxbUs_bmJsnCtzYZ7obXDcGz2gOe_3GvFl_dj141aTyF07LLGsZbpHwTnxxjug20VW1j0QAV49n9UN_1ZfHJ-mQvzh866Lvtq1BbYQ"`);
        expect(search.get('__fs_auth_date')).toMatchInlineSnapshot(`"Tue, 03 Sep 2024 10:57:45 +0000"`);
        expect(search.get('__fs_expires_in')).toMatchInlineSnapshot(`"31536000"`);
    });
